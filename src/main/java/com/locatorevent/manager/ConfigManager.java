...
public class ConfigManager {
    ...
    public void reload() {
        ...
        try {
            this.bossBarColor = BossBar.Color.valueOf(config.getString("bossbar.color", "BLUE").toUpperCase());
        } catch (IllegalArgumentException e) {
            this.bossBarColor = BossBar.Color.BLUE;
        }

        try {
            this.bossBarStyle = BossBar.Overlay.valueOf(config.getString("bossbar.style", "SOLID").toUpperCase());
        } catch (IllegalArgumentException e) {
            this.bossBarStyle = BossBar.Overlay.PROGRESS;
        }
    ...
    public Set<String> getWorldSet() { return worldList; }
    public List<String> getWorldList() { return List.copyOf(worldList); }
