...
public class ConfigManager {
    ...
    private Set<String> worldHashSet;
    ...
    public void reload() {
        ...
        this.worldList = config.getStringList("event.worlds.list");
        this.worldHashSet = new HashSet<>(worldList);
    ...
    public boolean isInWorldList(String worldName) { return worldHashSet.contains(worldName); }
